...
class GlobalConfig(BaseSettings):
    ...
    logger_name: str = "aopcs-lambda-logger"
    bucket_name: str
    aopcs_path: str
    secret_manager_arn: str
    data_source: DataSourceEnum = DataSourceEnum.S3
    kineis_auth_url: str = "https://services.kineis.com/auth/realms/Kineis/protocol/openid-connect/token"
    kineis_api_url: str = "https://api.kineis.com/aopcs/v1/allcast"
